...
export default function PortalExample() {
  ...
  <div className="bg-[oklch(0.141_0.005_285.823)] w-full flex space-x items-center justify-center">
    ...
    <Card style={{ width: '18rem' }} className='mr-20'>
    <Card.Img src={pdfHomePage} alt="Analytics Home Page" className="h-32 w-39 ml-20" />
    <Card.Body>
    ...
    <Card.Text className="text-md text-white ml-1">
        ...
        <Button variant="dark" className="ml-20 text-blue-500 mb-2 mt-4">Go Questions</Button>
      </Card.Body>
    ...
    <Card.Img src={supportHomePage} alt="Analytics Home Page" className="h-32 w-34 ml-20" />
    <Card.Body>
    ...
    <Card.Text className="text-md text-white ml-1">
        ...
        <Button variant="dark" className="ml-20 text-blue-500 mb-2 mt-4">Go Requests</Button>
      </Card.Body>
      <Card.Footer className='mb-2'>
      <small className="text-muted ml-2">Last updated 3 mins ago</small>
      </Card.Footer>
